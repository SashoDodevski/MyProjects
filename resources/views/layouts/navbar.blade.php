<nav class="bg-primary border-gray-200 px-2 sm:px-4 dark:bg-gray-900">
  <div class="flex flex-wrap mx-8 my-2 lg:my-0">
    <div class="flex">
      ...
      <a href="{{ route('home') }}" class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Brainster Academies Projects</a>
    </div>
    ...
    <div class="sm:flex sm:flex-row w-full md:block md:w-auto ml-auto lg:ml-0 mr-0 md:border-l-2 md:border-r-2 border-dotted border-gray-300 md:my-3">
      <ul class="flex flex-row p-4 bg-primary md:space-x-8 mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 float-right">
        @if (Route::has('login'))
        @auth

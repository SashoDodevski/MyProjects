    ...
    <div class="container" id="show">
        <div class="row">
            <div class="col-4 offset-1 mt-5">
                <h1 class=" mt-5">The Small Business</h1>
        ...
        <div class="row">
            <div class="col-4 offset-1">
                <h4 class="mt-3">Hello {{ $userNEW['name'] }}</h4>
                
                <p>Your name is {{ $userNEW['name'] }}</p>
                <p>Your last name is {{ $userNEW['lastName'] }}</p>
                @if($userNEW['email'] != "")
                <p>Your email is {{ $userNEW['email'] }}</p>
                @endif
            </div>
        </div>
    </div>
